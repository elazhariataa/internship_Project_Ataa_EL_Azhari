import { Avatar, Box, Button, Card, CardActions, CardContent, CardHeader, Divider, Grid, TableRow, TextField, Typography } from '@mui/material';
...
function AdminProfile(){
    ...
    useEffect(()=>{
        const getData = async ()=>{
            const res = await axios.get(`http://localhost:5000/admin/spcAdmin/${userId}`);
            return res.data;
        }
        getData()
        .then((user)=>{
    ...
    const updateAdminInfos = ()=>{
        const config = {
            method : "put",
            url : `http://localhost:5000/admin/updateAdmin/${userId}`,
            data : {
                userName : userName,
                firstName : firstName,
                lastName : lastName,
    ...
    const updatePic = ()=>{
        ...
        axios.put(`http://localhost:5000/admin/updatePhoto/${userId}`, formData, {
                ...
                <div className='profilePart2'>
                    <Card className="Card">
                        ...
                        <CardActions sx={{ justifyContent: 'flex-end',padding:"10px"}}>
                            <Button variant="contained" sx={{margin:"10px"}} onClick={()=>updateAdminInfos()}>
                                Save Changes
                            </Button>
                        </CardActions>
                    </Card>
