...
import '../../adminSpace/dashboard/adminDashboard.css';
...
export default function TraineDashboard({ children }) {
  ...
  const handleDrawerClose = () => {
    ...
    React.useEffect(() => {
      const toggleDrawerOnResize = () => {
        if (document.body.offsetWidth < 1216) setOpen(false);
        else setOpen(true);
      };
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} sx={{ display: 'flex', flexDirection:"row",justifyContent:"space-between" ,backgroundColor:"#161e2b",}}>
        <Toolbar>
          <IconButton
            color="inherit"
        ...
        <Box sx={{marginRight:"3%"}}>
            <IconButton
              ...
              >
                <MenuItem component={Link} to='/traineeProfile'><PersonIcon/> Profile</MenuItem>
      ...
      >
        <DrawerHeader className='drawerHeader'>
            ...
            <Typography noWrap component="div" sx={{fontFamily:"'Bebas Neue', sans-serif",fontSize: "30px",marginBottom:"7px"}}>
                GYM LINK
          </Typography>
        ...
        >
            ...
            >
              <ListItemButton
                sx={{
                    '&:hover':{
                        backgroundColor:"#252e3e",borderRadius:"5px"
                    }
                }}
              >
            ...
            >
              ...
              >
                ...
                <ListItemText primary="My Testimolials"/>
              </ListItemButton>
            </ListItem>
            {/* ------------- another item --------------- */}
        </List>
